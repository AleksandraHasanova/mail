...
email_body = Text(width=45, height=10)
email_body.grid(row=4, column=1, sticky=W)

Button(text='Отправить сообщение', command=send_email).grid(row=5, column=1, sticky=W)
